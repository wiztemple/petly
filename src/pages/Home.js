              ...
              <div className="md:flex items-center justify-between md:rounded-full bg-gray1 dark:bg-kiwi2 py-5 md:py-0 md:pl-8 pl-4 pr-4 md:pr-0">
                <div className="md:flex md:space-x-10">
                  <div className="relative flex items-center">
                    ...
                    <select
                      className="md:px-2 px-5 md:w-36 w-full py-3 bg-gray1 dark:bg-kiwi2 text-sm text-gray2"
                      id="location"
                      value={location}
                  ...
                  <div className="relative flex items-center">
                    ...
                    <select
                      className="px-5 md:w-36 w-full py-3 bg-gray1 dark:bg-kiwi2 text-sm text-gray2"
                      id="animal"
                      value={animal}
